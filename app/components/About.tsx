...
export default function about () {
    ...
    <div className='m-7'>
        ...
        <h1 className='text-3xl m-3 font-bold text-blue-600'>I Used Components:</h1>
    
    <ol className='text-2xl m-2'> My Name is Sameer Khan.</ol>
    <ol className='text-2xl m-2'> I completed Assingment No-2.</ol>
